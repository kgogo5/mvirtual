        ...
        <Section sectionPadding="40px 15px 140px" animation={false}>
          <Box m="0 auto" maxWidth="1164px" textAlign="left">
            ...
            <Text type="description" color="#fff" fontWeight={400}>
              {lang === "ko" ? (
                <>
                  엠버추얼은 모델이 필요한 여러 산업 분야에 기업의 원하는 모든
                  모델 이미지를 Ai가상인간으로 구현하여 가상인간 모델을
                  공급해드리고 있습니다. <br />
                  <br />
                  엠버추얼의 가상인간 기술력은 Ai딥러닝 제작방식으로 1분
                  가상인간 영상을 제작 하는데 기존 3D제작방식으로 수개월 걸렸던
                  제작속도를 24시간으로 단축시켰고 사람과 유사도 98%로 매우
                  자연스럽습니다.
                  <br />
                  <br />
                  또한 자체 100만 조회수 이상의 여러 인기 영상을 제작 했던 전문
                  영상팀과 A스타트업 런칭 7월만에 월 80억의 매출을 만들어 낸
                  전문 마케팅팀을 보유하고 있습니다.
                  <br />
                  <br />
                  엠버추얼은 가상인간 제작 뿐 아니라 가상인간을 활용하여
                  기획력있는 영상제작과 마케팅까지 가능한 기업입니다. <br />
                  <br />
                  현재 가상인간 시장은 제작비용이 너무 커서 대부분 대기업에서만
                  활용이 되고 있습니다. 하지만 저희는 좀 더 많은 기업들이
                  가상인간을 활용 할 수 있도록 가상인간 제작 비용을 타사 대비
                  1/10로 대폭 낮추었습니다.
                </>
              ) : (
                <>

...
const Market = () => {
  ...
  return (
    <>
      <Helmet>
        <title>엠버추얼 | Market</title>
        <meta name="description" content="가상인간 시장" />
      </Helmet>
                  ...
                  <Text type="description" color="#fff" fontWeight="400">
                    {lang === "ko" ? (
                      <>
                        ...
                        광고모델, 가수등으로 활동영역을 넓혀가면서 가상인간
                        시장이 고속 성장하고 있습니다.
                      </>
                    ) : (
                      <>
                        According to Bloomberg News in the United States, the
                        size of the virtual human influencer market will be six
                        times larger than now. In 2025, reaching about $11
                        billion, it will exceed the size of the human influencer
                        market.
                        <br />
                        <br />
                        In addition, according to Emergen Research, a global
                        market research company, the global virtual human market
                        is expected to reach about $52 billion by 2030, more
                        than 50 times higher than now.
                        <br />
                        <br />
                        The Big Bang of the Virtual Human Market, a new blue
                        ocean of the future, has begun. The virtual human market
                        is growing rapidly as overseas virtual human influencers
